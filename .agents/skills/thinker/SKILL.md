...
setItems(prev => [...prev, newItem]); // âœ…
// vs
prev.push(newItem); // âŒ
...
Question: New feature architecture
    â”‚
    â”œâ”€â”€ Does it need global state?
    â”‚   â””â”€ Yes â†’ Zustand store
    â”‚   â””â”€ No â†’ Local state (useState)
    â”‚
    â”œâ”€â”€ Does it fetch from API?
    â”‚   â”œâ”€ Yes â†’ React Query
    â”‚   â””â”€ No â†’ Static data
    â”‚
    â””â”€â”€ Does it affect multiple screens?
        â”œâ”€ Yes â†’ Global state + URL params
        â””â”€ No â†’ Local state
```

### State Location Decision

```
Data Type â†’ Where to Store
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
User session â†’ Zustand
App settings â†’ Zustand
Cached API data â†’ React Query
Form input â†’ Local useState
Derived from above â†’ Memoize
```

### Error Handling Decision

```
Error Type â†’ Handling
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
Network error â†’ Toast + retry
Auth error â†’ Redirect login
Validation â†’ Inline message
Server error â†’ Toast + log
Unexpected â†’ Catch + report
```
...
- âŒ Jumping to solutions
- âŒ Assuming the problem
- âŒ Not reading the code
- âŒ Shotgun debugging
- âŒ Skipping root cause analysis
- âŒ Not verifying fix
