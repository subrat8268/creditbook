...
â”œâ”€â”€ FeatureName.tsx        # Main component (exports default)
â”œâ”€â”€ FeatureList.tsx        # List/render-many component  
â”œâ”€â”€ FeatureCard.tsx       # Card/item component
â”œâ”€â”€ FeatureModal.tsx      # Modal component
â””â”€â”€ FeatureHeader.tsx    # Header/search component
```
...
- âŒ Creating files outside organized structure
- âŒ Using Context API (use Zustand)
- âŒ Direct API calls without Supabase MCP
- âŒ Inline styles (use Tailwind + NativeWind)
- âŒ Creating new types without checking schemas.ts
